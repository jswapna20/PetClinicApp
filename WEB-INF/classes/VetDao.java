   ...
   import com.petclinic.BaseDao;
   import com.petclinic.Speciality;
	...
	public class VetDao extends BaseDao {
		/*private static SessionFactory sessionFactory;
		  ...
		  public static void main(String[] args){
				try
				{
					sessionFactory = new AnnotationConfiguration().configure().addPackage("com.petclinic").addAnnotatedClass(Vet.class).addAnnotatedClass(Speciality.class).buildSessionFactory();
				}
				catch(Exception e)
				{
		...
		public Collection<Vet> getVet(String vetName){
				...
				try
				{
					...
					Query query = session.createQuery("From com.petclinic.Vet where vetName like ?");
		...
		public Collection<Speciality> getSpeciality(String specialityName){
				...
				{
					tx = session.beginTransaction();
					Query query = session.createQuery("From com.petclinic.Speciality where specialityName like ?");
